...
\fi
	...
	In payment channel network, such as the lightning network, the channel
	procure a fee to the operator if payment route passes the channel.
	Currently the fee is mostly manually set procuring an unoptimized profit to
	 the operator.
	
	A simulation study was performed where many policies was 		 

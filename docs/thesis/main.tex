...
\def\mytitle{Emergent Routing Strategies in the Lightning Network}
		...
		\begin{center}
	  		...
	  		\begin{large}
	  			\begin{tabular}{ll}
	  				...
	  				\textbf{Examinor} & Henrik Björklund \\
	  			\end{tabular}
	  			\vfill
	  			\vfill
	  		\end{large}
	  		
	  		\scriptsize{* whom correspondence should be addressed. E-mail: john-john@markstedts.org}

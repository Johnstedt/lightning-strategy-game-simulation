...
Consider a Revocable Sequence Maturity Contract seen in Figure \ref{fig:RSMC}. It is constructed by Alice and she used Bob's master public key to derive Bob's revocation public key in some prearranged manner. To invalidate the $CT$, Alice need only to disclose the private key corresponding to her revocation public key for Bob to be able to revoke a violati`([])on. 
